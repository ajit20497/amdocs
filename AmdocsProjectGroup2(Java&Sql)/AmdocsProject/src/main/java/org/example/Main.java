...
public class Main {
    String url = "jdbc:mysql://localhost:3306/amdocsbloodmanagment";
    String user = "root";
...
//                }
    ...
    public static void donorDashBoard(Scanner scanner) {
        final String url = "jdbc:mysql://localhost:3306/amdocsbloodmanagment";
        final String user = "root";
        final String password = "Asdf@123";
        int choice = 4;
        do {
            System.out.println(" ");
            ...
            switch (choice) {
                case 1: {
                    ...
                    try {
                        // Establish the database connection
                        System.out.println("Enter name,bloodGroup,contactDetails,donorAge");
                        ...
                        String donorAge = scanner.nextLine();

                        Connection connection = DriverManager.getConnection(url, user, password);

                        // Prepare the SQL insert statement
                        String insertQuery = "INSERT INTO Donor (donorName, bloodGroup, contactDetails, donorAge) VALUES (?, ?, ?, ?)";
                        ...
                        preparedStatement.setString(4, donorAge);
                ...
                case 2: {
                    ...
                    try  {
                        ...
                        switch (fieldChoice) {
                            ...
                            case 4:{
                                updateQuery = "UPDATE Donor SET donorAge = ? WHERE id = ?";
                                break;
                            }
            ...
            switch (choice) {
                case 1: {
                    ...
                    try {
                        // Establish the database connection
                        System.out.println(" ");
                        System.out.println("Enter ReceiverName,requiredBloodGroup,contactDetails,address,ReceiverAge");
                        ...
                        String receiverAge=scanner.nextLine();

                        Connection connection = DriverManager.getConnection(url, user, password);

                        // Prepare the SQL insert statement
                        String insertQuery = "INSERT INTO Receiver (receiverName, requiredBloodGroup, contactDetails,address,receiverAge) VALUES (?, ?, ?, ?, ?)";
                        PreparedStatement preparedStatement = connection.prepareStatement(insertQuery);
                        preparedStatement.setString(1, receiverName);
                        preparedStatement.setString(2, requiredBloodGroup);
                        preparedStatement.setString(3, contactDetails);
                        preparedStatement.setString(4,address);
                        preparedStatement.setString(5,receiverAge);
                ...
                case 3: {
                    try {
                        ...
                        if (!resultSet.next()) {
                            ...
                            String receiverAge= resultSet.getString("receiverAge");
                            //
                            System.out.println("ID: " + id1);
                            ...
                            System.out.println("Age: "+receiverAge);
